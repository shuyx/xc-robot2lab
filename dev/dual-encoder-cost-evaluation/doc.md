...
|---|---|---|
| 编码器数量 | **双编码器**（电机侧 + 输出侧） | **单编码器**（电机侧） |
| 输出端反馈 | 物理编码器直接测量 | 软件估算（÷减速比） |
| 背隙补偿 | 可闭环补偿 | 无法补偿 |
| 典型型号 | DM-J8009-2EC | RS04 |

<!-- 注意事项 -->
<div class="callout callout-warn">
⚠️ <strong>注意</strong>：OpenARMX 团队替换电机后，编码器能力相比原版是<strong>退化</strong>的。换回达妙不仅升级硬件，还能复用原版 OpenARM 大量的驱动代码和调参经验。
</div>
